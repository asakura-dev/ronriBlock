...
window.onload = function(){
	...
	/*----------------------
	  Preload Images
	  ----------------------*/
	var preload_imgs = ["toolbox.png","workspace.png","blackhole.png","input.png","output.png","not3.png","and.png","or.png","value.png","0.png","1.png","migi.png","hidari.png","ue.png","sita.png","uemini.png","sitamini.png","splitter2.png"];
	...
	core.onload = function(){
		...
		var DownLineBlock = Class.create(RonriBlock,{
				initialize:function(origin){
					RonriBlock.call(this,origin);
					this.setInputNode(20,20,0,0,CONNECTOR);
					this.setOutputNode(20,20,0,50,CONNECTOR);
					this.addEventListener(enchant.Event.TOUCH_END,function(){
							if(game_status == BUILDING){
								if(this.touchEndCommonAction() == 0){
									this.updateNodeStatus();
		...
		var inputBlockOrigin = new BlockOrigin(80,40,10,10,"input.png","InputBlock");
		var outputBlockOrigin = new BlockOrigin(80,40,110,10,"output.png","OutputBlock");
		var notBlockOrigin = new BlockOrigin(140,60,210,10,"not3.png","NotBlock");
		var andBlockOrigin = new BlockOrigin(140,80,370,10,"and.png","AndBlock");
		var orBlockOrigin = new BlockOrigin(140,80,530,10,"or.png","OrBlock");
		var oneBlockOrigin = new BlockOrigin(30,30,690,10,"1.png","ValueBlock");
		var zeroBlockOrigin = new BlockOrigin(30,30,740,10,"0.png","ValueBlock");
		var rightLineBlockOrigin = new BlockOrigin(80,20,790,10,"migi.png","RightLineBlock");
		var leftLineBlockOrigin = new BlockOrigin(80,20,790,50,"hidari.png","LeftLineBlock");
		var upLineBlockOrigin = new BlockOrigin(20,80,890,10,"ue.png","UpLineBlock");
		var upMinLineBlockOrigin = new BlockOrigin(20,50,1070,10,"uemini.png","UpMiniLineBlock");
		var downLineBlock = new BlockOrigin(20,80,930,10,"sita.png","DownLineBlock");
		var downMiniLineBlock = new BlockOrigin(20,50,1140,10,"sitamini.png","DownMiniLineBlock");
		var splitterBlock = new BlockOrigin(80,80,970,10,"splitter2.png","SplitterBlock");
	}
	core.start();
};